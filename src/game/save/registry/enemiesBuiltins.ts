...
const entityToKind = (e: Entity): EnemyKind | null => {
  ...
  if (e instanceof DarkBush) return "dark_bush";
  if (e instanceof DarkShrub) return "dark_shrub";
  if (e instanceof DarkSprout) return "dark_sprout";
  if (e instanceof DarkSucculent) return "dark_succulent";
  ...
  if (e instanceof DarkFirTree) return "dark_fir_tree";
  if (e instanceof DarkTree) return "dark_tree";
  if (e instanceof DarkBigTree) return "dark_big_tree";
...
export const registerBuiltinEnemyCodecsV2 = (): void => {
  ...
  registerBasic("dark_bush", DarkBush);
  registerBasic("dark_shrub", DarkShrub);
  registerBasic("dark_sprout", DarkSprout);
  registerBasic("dark_succulent", DarkSucculent);
  registerBasic("sprout", Sprout);
  registerBasic("lily_plant", LilyPlant);
  registerBasic("tree", Tree);
  registerBasic("big_tree", BigTree);
  registerBasic("dark_tree", DarkTree);
  registerBasic("dark_fir_tree", DarkFirTree);
  registerBasic("dark_big_tree", DarkBigTree);
